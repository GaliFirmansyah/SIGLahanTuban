<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <ul class="flex text-gray-500 text-sm lg:text-base">
                ...
                <li class="inline-flex items-center">
                    <x-nav-link :href="route('lahan.show',['lahan' => $lahan->id])" :active="request()->routeIs('lahan.show',['lahan' => $lahan->id])">
                        {{ __('Lahans Details') }}
                    </x-nav-link>
                    <svg class="h-5 w-auto text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <h1 class="text-center text-4xl font-bold my-3">Lahan Detail</h1><hr>
    ...
    <x-slot name="script">
        <script>
            ...
            var alamat = {!! json_encode($lahan->alamat) !!}
            var pemilik = {!! json_encode($lahan->pemilik) !!}
            var image = {!! json_encode(asset('images/padi.png')) !!}
