...
<head>
    ...
    <title>Lahan Pertanian Kab. Tuban</title>
    ...
    <header id="header" style="background-color: #030225;">
        ...
        <div class="profile">
            <img src="images/kominfo.png" alt="" class="img-fluid rounded-circle" style="height: 120px;">
            <h1 class="text-light"><a href="index.html">Kelompok 1</a></h1>
        ...
        <nav class="nav-menu">
            ...
            <li><a href="#about"><i class="bx bx-map"></i> <span>Letak Lahan</span></a></li>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
        <div class="hero-container" data-aos="fade-in">
            <h1>WEBGIS</h1>
            <p><span class="typed" data-typed-items="MAHASISWA TEKNIK INFORMATIKA, UNESA"></span></p>
        </div>
    </section><!-- End Hero -->
    <main id="main">
        @yield('content')
    ...
    <footer id="footer">
        <div class="container">
        <div class="copyright">
            &copy; Copyright <strong><span>Tim 1</span></strong>
        </div>
        {{-- <div class="credits">
